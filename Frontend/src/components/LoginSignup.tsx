...
import { ArrowRight, Eye, EyeOff, Mail, Lock, User, Brain, Zap, Star, Users, TrendingUp } from 'lucide-react';
...
const LoginSignup: React.FC<LoginSignupProps> = ({ onComplete }) => {
  ...
  const handleSocialLogin = (provider: 'google' | 'linkedin') => {
    ...
    const mockUserData = {
      ...
      // Remove pre-filled experience data to force experience setup
      experience: '',
      currentRole: '',
      targetCompanies: [],
      region: ''
